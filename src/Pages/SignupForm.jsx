      ...
      <div className="flex items-center justify-center bg-[#050122] lg:py-40 py-20 px-2 relative inter">
        ...
        <div className="bg-[#0c072c] lg:p-8 py-8 px-5 rounded-2xl w-full max-w-[35rem] border-[0.1px] border-[#453995]">
          <div className="mb-14">
            ...
            <p className="text-sm text-white font-thin">Glad to have you on board! Create your email account with
              Web3mail now.</p>
          </div>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                <div
                    className={`flex justify-center items-center p-4 transition-all py-3 lg:py-5 rounded-xl bg-[#161134] text-white ${emailAvailability === 'Taken' ? 'border-2 border-red-500' : emailAvailability === 'Available' ? 'border-2 border-green-500' : ''
                    }`}>
                  <input
                      type="text"
                      name="email"
                ...
                {emailAvailability && (
                    <div ref={suggestionsRef}
                         className="absolute left-0 mt-2 w-full p-2 rounded-lg bg-[#050122] border-[0.1px] border-[#453995] z-10">
                      <div
                          className={`p-2 text-sm rounded-lg ${emailAvailability === 'Taken' ? 'text-red-500' : 'text-green-500'}`}>
